...
public class FactionImpl extends ObservedEntity implements Faction {
  ...
  public FactionImpl(FactionData info, War war) {
    super(info.id);
    name = info.name;
  ...
  public FactionBannerPattern getBannerPattern() {
    return appearance.bannerPattern;
  }

  @Override
  public void setBannerPattern(FactionBannerPattern newBannerPattern) {
    this.appearance.bannerPattern = newBannerPattern;
  ...
  public void setCapitalSector(Sector sector) {
    ...
    onChangeProperty("capitalSectorId", Integer.toString(sector.getId()));
  }
